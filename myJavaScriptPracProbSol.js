...
//
console.log(" ===== Division Stringfield =====");
...
//
console.log(" ===== Counting Minutes I =====");
...
//
console.log(" ===== Overlapping Ranges =====");
...
//
console.log(" ===== Nonrepeating Character =====");
...
//
console.log(" ===== Palindrome Creator =====");
...
//
console.log(" ===== Basic Roman Numerals =====");
...
//
console.log(" ===== Alphabet Searching =====");
/*
...
console.log(`the man is here for the [${ploMan},and ${ploMon}]`);
...
function transformEmployeeData(array) {
  ...
  for(var i = 0; i < array.length; i++) {
    ...
    for(var j = 0; j < array[i].length; j++) {
      temp_Result[array[i][j][0]] = array[i][j][1];
    }
    fin_Result.push(temp_Result);
  }
